...
void fp6_mul_sparse_add_lazy_montgomery(fp6_t *ANS,fp6_t *A,fp6_t *B){  //?000?? * ??????
  ...
  fp_mul_nonmod(&tmp4_fpd2.x0,&tmp_A.x0.x0,&tmp2_fp2.x0);
  fp_mul_nonmod(&tmp4_fpd2.x1,&tmp_A.x0.x0,&tmp2_fp2.x1);

  //(a+c)(d+e+f) = tmp5
  fp_add_nonmod_single(&tmp1_fp2.x0,&tmp_A.x0.x0,&tmp_A.x2.x0);
  fp_set(&tmp1_fp2.x1,&tmp_A.x2.x1);
  ...
  //ad = tmp1
  fp_mul_nonmod(&tmp1_fpd2.x0,&tmp_A.x0.x0,&tmp_B.x0.x0);
  fp_mul_nonmod(&tmp1_fpd2.x1,&tmp_A.x0.x0,&tmp_B.x0.x1);
...
void fp6_mul_sparse_dbl_lazy_montgomery(fp6_t *ANS,fp6_t *A,fp6_t *B){  //??0?00 * ??????
  ...
  //(a+b)(d+e) = tmp4
  fp_set(&tmp1_fp2.x0,&tmp_A.x0.x0);
  fp_add_nonmod_single(&tmp1_fp2.x1,&tmp_A.x0.x1,&tmp_A.x1.x1);
  fp2_add_nonmod_single(&tmp2_fp2,&tmp_B.x0,&tmp_B.x1);
  ...
  //(a)(d+f) = tmp6
  fp2_sub_nonmod_single(&tmp2_fp2,&tmp2_fp2,&tmp_B.x1);
  fp2_mul_nonmod_montgomery(&tmp6_fpd2,&tmp_A.x0,&tmp2_fp2);

  //ad = tmp1
  fp2_mul_nonmod_montgomery(&tmp1_fpd2,&tmp_A.x0,&tmp_B.x0);

  //be = tmp2
  fp_mul_nonmod(&tmp2_fpd2.x1,&tmp_A.x1.x1,&tmp_B.x1.x0);
  fp_mul_nonmod(&tmp2_fpd2.x0,&tmp_A.x1.x1,&tmp_B.x1.x1);
...
//ELiPS sqr
  ...
  fp2_set_conj_montgomery(&tmp4_fp2, &tmp_A.x0); //a_
  fp2_set_conj_montgomery(&tmp5_fp2, &tmp_A.x1); //b_
  fp2_set_conj_montgomery(&tmp6_fp2, &tmp_A.x2); //c_
