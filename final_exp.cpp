...
//   fp6_frobenius_map_p1_montgomery(&tmp1_fp6,ANS);//(p^3-1)(p)
//   fp6_mul_lazy_montgomery(ANS,ANS,&tmp1_fp6);         //(p^3-1)(p+1) = M
//   fp6_set(&tmp1_fp6, ANS);
//   //Second part
// //L1
//   fp6_frobenius_map_p3_montgomery(&tmp6_fp6, ANS);            //M^-1
//   fp6_sqr_GS_lazy_montgomery(&tmp6_fp6, &tmp6_fp6);           //M^-2
//   fp6_frobenius_map_p1_montgomery(&tmp7_fp6, ANS);            //M^p
//   fp6_finalexpow_x_2NAF_lazy_montgomery(&tmp8_fp6, ANS);      //M^x
//   fp6_mul_lazy_montgomery(&tmp9_fp6,&tmp7_fp6,&tmp8_fp6);     //M^*(p+x-2)            
//   // fp6_mul_lazy_montgomery(&tmp9_fp6, &tmp9_fp6, &tmp6_fp6);
...
//   fp6_mul_lazy_montgomery(ANS, ANS, &tmp11_fp6);         //left * right = M^(1+ (p+t0-2)((9w^2+3w+1)(x-1)+9w^2+6w)(x-1)+9w^2+9w + 3) //M
//   fp6_mul_lazy_montgomery(ANS, ANS, &tmp1_fp6);          //left * right = M^(2+ (p+t0-2)((9w^2+3w+1)(x-1)+9w^2+6w)(x-1)+9w^2+9w + 3) //M
//   fp6_mul_lazy_montgomery(ANS, ANS, &tmp1_fp6);          //left * right = M^(3+ (p+t0-2)((9w^2+3w+1)(x-1)+9w^2+6w)(x-1)+9w^2+9w + 3) //M
