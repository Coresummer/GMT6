...
CXX = clang++-12
PROGRAM = CP6
OBJS   = main.o scalar.o mpn.o mul.o fp.o mcl.o create.o field_test.o #fp2.o fp6.o efp.o efp2.o efp6.o test_efp.o miller.o final_exp.o test_pairing.o time.o
