...
OBJS   = main.o   count.o scalar.o mpn.o fp.o fp3.o fp6.o test_fp.o efp.o efp3.o efp6.o test_efp.o create.o 
HEADER = define.h count.h scalar.h mpn.h fp.h fp3.h fp6.h test_fp.h efp.h efp3.h efp6.h test_efp.h create.h 

$(PROGRAM): $(OBJS)
	$(CC) -g -o $(PROGRAM) $(OBJS) -O2 -march=native -lgmp -v -da -Q
