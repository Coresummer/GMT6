...
OBJS   = main.o   count.o scalar.o mpn.o fp.o fp2.o fp6.o test_fp.o efp.o efp2.o efp6.o test_efp.o create.o 
HEADER = define.h count.h scalar.h mpn.h fp.h fp2.h fp6.h test_fp.h efp.h efp2.h efp6.h test_efp.h create.h 
