...
void ff_lttp_costello(fp6_t *f, efp_jacobian_t *U, efp_t *S){//U = S, S = P
  ...
  fp_mul(&tmpD_fp,&tmpD_fp, &base_d);  //D = 3bC (b=-1, twisted b= -base_d)
...
//-----------------------------------------------
  ...
  // fp_mul(&tmp1_fp6.x0.x0,&tmp1_fp6.x0.x0,&base_d_inv);     //(D-B)*d^-1
//-----------------------------------------------
  fp_set_neg(&tmp1_fp6.x0.x1,&tmpF_fp);             //-F
  fp_mul(&tmp1_fp6.x0.x1,&tmp1_fp6.x0.x1,&S->y);    //-FSy
  // fp_mul(&tmp1_fp6.x0.x1,&tmp1_fp6.x0.x1,&base_d_inv);     //(-FSy)*d^-1
...
//-----------------------------------------------
  ...
  // fp_mul(&tmp1_fp6.x2.x0,&tmp1_fp6.x2.x0,&base_d_inv);     //(3ASx)*d^-1
//-----------------------------------------------
  // fp6_mul_sparse_dbl(f,&tmp1_fp6,f);        //Capable for further Karatsuba //update
  fp6_mul(f,&tmp1_fp6,f);
...
//-----------------------------------------------
  ...
  // fp_mul(&tmp1_fp6.x0.x1,&tmp1_fp6.x0.x1,&base_d_inv);     //(3ASx)*d^-1
  fp_l1shift(&tmp1_fp6.x0.x1,&tmp1_fp6.x0.x1);
//-----------------------------------------------
  ...
  // fp_mul(&tmp1_fp6.x1.x0,&tmp1_fp6.x1.x0,&base_d_inv);     //(3ASx)*d^-1
//-----------------------------------------------
  fp_mul(&tmp1_fp6.x1.x1,&tmpD_fp,&S->y);       //(X1-X2Z1)yS
  fp_set_neg(&tmp1_fp6.x1.x1,&tmp1_fp6.x1.x1);  //(X1-X2Z1)
  // fp_mul(&tmp1_fp6.x1.x1,&tmp1_fp6.x1.x1,&base_d_inv);     //(3ASx)*d^-1
//-----------------------------------------------
...
void ff_lttp_costello_lazy_montgomery(fp6_t *f, efp_jacobian_t *U, efp_t *S){//U = S, S = P
  ...
  // fp_mulmod_montgomery(&tmpD_fp,&tmpD_fp, &base_d_inv_montgomery);  //D = 3bC (b=-1, twisted b= -base_c_inv)
